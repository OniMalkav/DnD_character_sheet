...
export default function SpellsTab() {
  const {
    ...
    spells, addSpell, removeSpell, toggleSpellPrepared, charInfo, triggerRoll, setActiveTab
  } = useCharacter();
        ...
        <Card className="flex flex-col">
          ...
          <CardContent className="flex-1 flex flex-col">
            <div className="flex gap-2 mb-4">
              ...
              <Button onClick={handleAddSpell} disabled={!newSpellName.trim()} size="icon" style={{ backgroundColor: THEME.colors.addBtnBg, color: THEME.colors.addBtnText }}>
                              ...
                              >
                                <div className="flex items-center gap-2">
                                  <input
                                    ...
                                    className="w-[1em] h-[1em] cursor-pointer accent-primary"
                                    title="Prepared"
                                  />
